        ...
        case UIGestureRecognizerStateEnded:
            switch (_positionMode) {
                ...
                case SpreadPositionModeTouchBorder:
                {
                    ...
                    //                        destinationLocation = CGPointMake(location.x, self.bounds.size.width/2 + _touchBorderMargin + 88);
                    //                    } else if (location.y > superViewSize.height - magneticDistance) {//下面
                    //                        destinationLocation = CGPointMake(location.x, superViewSize.height - self.bounds.size.height/2 - _touchBorderMargin - 88);
